...
function Talent(primus, sharejsConn)
{
...
Talent.prototype.acquireContexts = function(ids)
{
...
Talent.prototype._ids = function(ids, doSubscribe)
{
        var ret = [];

        ids.forEach(function(id)
        {
                var doc = this.sharejs.get('talent', id);
...
Talent.prototype.acquireAllContexts = function()
{
        return this._all()
        .then(function(ids)
        {
...
Talent.prototype.newEmptyTalent = function(talentContexts)
{
        return this.rpc('newEmptyTalent')
        .then(function(id)
        {
                ...
                {
                        var doc = docs[0];
                        if (doc && talentContexts)
                        {
                                doc.subscribe();
                                talentContexts.add(doc);
                        }
